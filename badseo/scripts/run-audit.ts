 ...
 *
 * This drives the REAL Run Your SEO audit engine (the same crawl + issue-detection
...
async function main() {
  ...
  // (rogerthenomad/Run-Your-SEO#61): the canonical page must resolve to a 200 with no
