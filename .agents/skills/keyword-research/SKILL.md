...
# Run Your SEO Keyword Research

## Goal

Turn seed topics into a prioritized keyword opportunity set using Run Your SEO MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
- Do not invent metrics. If Run Your SEO does not return a value, write `unknown`.
