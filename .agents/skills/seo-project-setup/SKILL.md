...
# Run Your SEO SEO Project Setup
...
### 5. Verify Run Your SEO MCP

After the user has described the company, website, goals, and positioning, check that Run Your SEO MCP is configured and mapped to the right project:
...
5. If the MCP is unavailable, tell the user to connect Run Your SEO MCP before continuing with live Run Your SEO data.
...
After intake, recommend one next Run Your SEO workflow:
...
- Working folder
- Run Your SEO MCP/project status
- Sites in scope
- Goals
- Known positioning
- Uploaded data/files
