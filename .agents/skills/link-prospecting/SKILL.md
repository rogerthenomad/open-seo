...
# Run Your SEO Link Prospecting

## Goal

Find realistic pages, sites, and authors that might reference the user's page, product, study, guide, or tool. Use Run Your SEO for prospect discovery, then use available web/search/browser tools for contact discovery.
...
After Run Your SEO identifies good prospects, use available non-Run Your SEO browsing or search tools for public contact discovery. Depending on the client, this may be web search, page fetches, browser automation, or a search API.
...
- Do not say Run Your SEO found contact details unless an Run Your SEO tool returned them. Attribute contact discovery to the web/search/browser source used.
