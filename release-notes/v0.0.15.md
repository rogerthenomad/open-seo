...
> [!NOTE]
> Run Your SEO now includes agent skills for guided SEO workflows. See [Run Your SEO Skills](../README.md#runyourseo-skills) for setup and available skills.

## What's new

- Add Run Your SEO agent skills for:
  - Keyword Research
  - Keyword Clustering
  - Competitor Analysis
  - Link Prospecting
...
Full Changelog: https://github.com/rogerthenomad/Run-Your-SEO/compare/v0.0.14...v0.0.15
