...
1. **Traceable truth.** Every capability claim, price, and screenshot is verifiable against the code, the fact sheet (`src/server/features/onboarding/runyourseo-fact-sheet.md`), or the live product. If you can't point to where it's true, it doesn't ship.
...
3. **Honest pricing, with its reasoning.** Quality SEO data is expensive everywhere — that's why the big suites run $100/month and up. Run Your SEO is the affordable option: $10/month, free to start. Never simply "free."
...
- If a reader trusted every claim and screenshot, then opened Run Your SEO right now, where would reality not match?
