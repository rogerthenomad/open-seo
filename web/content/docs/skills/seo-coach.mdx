...
- Help you choose the next Run Your SEO Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use Run Your SEO MCP, web search, browser review, or local files.
...
- "What does Run Your SEO help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [Run Your SEO MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Coach skill](https://github.com/rogerthenomad/Run-Your-SEO/tree/main/.agents/skills/seo-coach)
