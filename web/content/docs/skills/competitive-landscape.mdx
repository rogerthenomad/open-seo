...
Set up [Run Your SEO MCP](/docs/mcp) so your agent can research keywords, inspect SERPs, compare domains, and review backlink overview data when authority matters.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Competitive Landscape skill](https://github.com/rogerthenomad/Run-Your-SEO/tree/main/.agents/skills/competitive-landscape)
