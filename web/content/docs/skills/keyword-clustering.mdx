...
Set up [Run Your SEO MCP](/docs/mcp) so your agent can read saved keywords, inspect SERPs, and use Run Your SEO project context while clustering.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Clustering skill](https://github.com/rogerthenomad/Run-Your-SEO/tree/main/.agents/skills/keyword-clustering)
