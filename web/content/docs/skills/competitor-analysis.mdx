...
Set up [Run Your SEO MCP](/docs/mcp) so your agent can inspect domain overview data, ranking keywords, SERPs, and backlink context.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Competitor Analysis skill](https://github.com/rogerthenomad/Run-Your-SEO/tree/main/.agents/skills/competitor-analysis)
