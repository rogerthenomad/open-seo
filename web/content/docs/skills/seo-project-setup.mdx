...
- Recommend the next Run Your SEO Agent Skill to run.
...
Set up [Run Your SEO MCP](/docs/mcp) so your agent can confirm the right Run Your SEO project and use live SEO data in later workflows.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill](https://github.com/rogerthenomad/Run-Your-SEO/tree/main/.agents/skills/seo-project-setup)
