...
### Why does open source matter even if you're using Run Your SEO's SaaS?
...
Anyone can [self-host Run Your SEO](https://github.com/rogerthenomad/Run-Your-SEO) and use it at cost for themselves.
...
## Build a custom SEO tool on top of Run Your SEO
...
I propose that they should instead build on top of Run Your SEO. Here's why:
...
## Where does Run Your SEO get its data?

Run Your SEO uses [DataForSEO](https://dataforseo.com/) as its main data source. They have been in business for almost 10 years and are considered the gold standard for pay-by-usage SEO data. They have quality SEO data for almost every workflow and they are very reliable.
...
## Can you really replace your SEO tool with Run Your SEO?

It depends.

### For beginners

If you're new to SEO, Run Your SEO should definitely be the first tool you select. Good design means the tool is approachable to both beginners and experts. When you connect Run Your SEO with an AI agent, it can help coach you through the basics. Run Your SEO will grow with you.

### For experts

If you love your current solution, you should probably just stick with that. But, if you think your current tool is bloated, poorly designed, or too expensive, Run Your SEO is striving to be an all-in-one replacement for tools like [Semrush](https://www.semrush.com/) and [Ahrefs](https://ahrefs.com/).

## AI native: More than a replacement for other SEO tools

Run Your SEO is both open source and more affordable than alternatives. But, we do not plan for these to be the only things different about the product.
...
Run Your SEO aims to be the best way to collaborate with your AI agent on SEO tasks. Run Your SEO was created after AI agents became powerful. The product is not bogged down by features and workflows that only make sense in a pre-AI world.

Right now, this means Run Your SEO has an [MCP server](/docs/mcp) which you can use with any other AI product like Claude, Codex, or OpenClaw. For example, you can ask your agent to do keyword research. But instead of blindly trusting its judgment, you can ask it for a link to view the data in Run Your SEO.
