...
You can't force Google to hand them over. But you can reconstruct most of them, and the data you need is already sitting in three tools you probably already use. If you want an agent to do the heavy lifting, connect [Run Your SEO MCP](/docs/mcp) first so it can pull live keyword, ranking, SERP, and Search Console data. New to this? Start with the [SEO coach](/docs/skills/seo-coach).
...
- [Do it with Run Your SEO](#do-it-with-runyourseo)
...
## Do it with Run Your SEO

This is exactly the workflow the [Run Your SEO MCP](/docs/mcp) was built for. Because the Google Search Console connection runs _through_ Run Your SEO, you don't have to wire up a separate integration. Connect it once and query all three sources from the same agent.
...
Use Run Your SEO's ranked-keywords and keyword-research tools to find every term the page could plausibly be catching, not just the fourteen Google admitted to. The [keyword research skill](/docs/skills/keyword-research) makes this repeatable.
...
Expensive suites will happily charge you $100 to $200 a month and still hand you the same fourteen queries. The point of doing this in Run Your SEO isn't a prettier dashboard, it's that the Search Console, ranking, and MCP pieces are already connected, cheap, and scriptable, so triangulation becomes a prompt instead of a project.
