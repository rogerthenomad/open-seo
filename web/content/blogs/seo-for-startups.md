...
The screenshots below show what this data looks like in Run Your SEO.
...
![Run Your SEO domain overview showing top pages, keywords, and estimated traffic](/blog/seo-for-startups/domain-overview.png)
...
![Run Your SEO keyword research view showing related or suggested keywords for a seed term](/blog/seo-for-startups/keyword-research.png)
...
![Run Your SEO backlink analysis showing referring domains or top backlinks for a competitor](/blog/seo-for-startups/backlink-analysis.png)
...
For a focused outreach workflow, use the [link prospecting skill](/docs/skills/link-prospecting). If you want an AI agent to help with this work, [set up Run Your SEO MCP](/docs/mcp) so it can use live Run Your SEO data. If you are new to the process, start with [SEO coach](/docs/skills/seo-coach). For a fresh project, use [SEO project setup](/docs/skills/seo-project-setup) before jumping into research.
...
3. Set up [Google Search Console](https://search.google.com/search-console/about) and [Run Your SEO MCP](/docs/mcp)
