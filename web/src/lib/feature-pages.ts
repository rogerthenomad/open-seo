...
export const featurePages = {
  keywordResearch: {
    ...
    imageAlt: "Run Your SEO keyword research dashboard",
    imageSrc:
    ...
    faqs: [
      {
        question: "What is Run Your SEO keyword research best for?",
        answer:
          "Run Your SEO is best for finding SEO keyword ideas, checking demand and difficulty, and turning those ideas into saved keywords you can revisit.",
      },
      {
        question: "Can I use Run Your SEO as a free keyword research tool?",
        answer:
          "Not unlimited: quality keyword data costs money everywhere, which is why the big SEO suites run $100/month and up. Run Your SEO is the most affordable option; you can start for free, and paid plans start at $10/month with usage credits included. It's also open source, so you can self-host with your own DataForSEO account.",
      },
      {
        question: "Does Run Your SEO show live search results?",
        answer:
  ...
  siteAudit: {
    ...
    imageAlt: "Run Your SEO site audit report",
    imageSrc:
    ...
    faqs: [
      {
        question: "What does the Run Your SEO site audit tool check?",
        answer:
      ...
      {
        question: "Is Run Your SEO a free SEO audit tool?",
        answer:
          "For smaller sites, yes: the free plan includes site audits up to 50 pages per crawl. Larger crawls need a paid plan, starting at $10/month. Run Your SEO is also open source and self-hostable.",
      },
      {
        question: "Who should use Run Your SEO Site Audit?",
        answer:
  ...
  backlinkChecker: {
    ...
    imageAlt: "Run Your SEO backlinks report",
    imageSrc:
    ...
    related: [
      ...
      { label: "Domain Overview", href: "/features/domain-overview" },
      { label: "Run Your SEO MCP", href: "/features/mcp" },
    ],
    faqs: [
      {
      ...
      {
        question: "Can I check competitor backlinks in Run Your SEO?",
        answer:
  ...
  domainOverview: {
    ...
    imageAlt: "Run Your SEO domain overview",
    imageSrc:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Run Your SEO covers the core of the same report (estimated traffic, organic keywords, top keywords, and top pages) without a triple-digit monthly seat. Run Your SEO is open source, so you can self-host it, and the managed app is $10/month and includes usage credits.",
      },
      {
        question: "Can Run Your SEO help with competitor keyword analysis?",
        answer:
  ...
  rankTracking: {
    ...
    imageAlt: "Run Your SEO rank tracking table",
    imageSrc:
    ...
    differentiators: [
      ...
      "Run Your SEO can expose ranking data to AI agents through MCP.",
    ],
    related: [
      { label: "Keyword Clustering", href: "/docs/skills/keyword-clustering" },
      {
    ...
    faqs: [
      ...
      {
        question: "Does Run Your SEO track mobile and desktop rankings?",
        answer:
  ...
  savedKeywords: {
    ...
    imageAlt: "Run Your SEO saved keywords list",
    imageSrc:
  ...
  aiBrandVisibility: {
    ...
    imageAlt: "Run Your SEO AI brand visibility report",
    imageSrc:
    ...
    differentiators: [
      ...
      "Run Your SEO helps teams connect AI mention and citation research to concrete SEO planning.",
    ],
    related: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Traditional SEO focuses on rankings and pages. Run Your SEO's AI visibility workflow looks at mentions, cited pages, related prompts, and platform-level metrics from supported AI-search sources.",
      },
      {
  ...
  aiSearchPrompts: {
    ...
    imageAlt: "Run Your SEO prompt explorer",
    imageSrc:
    ...
    differentiators: [
      ...
      "Run Your SEO treats AI search as a research layer, not a replacement for SEO fundamentals.",
      "Run Your SEO MCP exposes keyword, SERP, domain, backlink, saved keyword, and rank-tracking tools to AI agents.",
    ],
    related: [
