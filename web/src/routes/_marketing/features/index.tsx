...
const featuresDescription =
  "Explore Run Your SEO's open-source SEO tools for AI-agent workflows, Google Search Console MCP, keyword research, rank tracking, backlinks, site audits, competitor analysis, and AI visibility.";
        ...
        <section>
          <div className="border-b border-[var(--color-border-subtle)] pb-4">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
              ...
              backlinks, and first-party Search Console data through Run Your SEO.
            </p>
          </div>
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            <FeatureCard href="/features/mcp">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--color-brand-muted)]">
                Connect Claude, Codex, and other agents to Run Your SEO research
                tools.
              </p>
