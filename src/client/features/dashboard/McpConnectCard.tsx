...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use Run Your SEO`,
    "Research my competitors top pages and keywords and tell me what's working. Use Run Your SEO",
  ];
}
        ...
        {connected ? (
          ...
          <>
            <div className="space-y-2 text-sm text-base-content/70">
              <p>
                Run Your SEO is designed to give your AI agent the data it needs
